...
public class SkillLoader
{
    ...
    public SkillLoader(ArdinCodeConfig config, ProjectRootAccessor projectRoot)
    {
        _config = config;
    ...
    /// from the project root looking for an existing ".ardincode/skills" directory —
    ...
    private string ResolveProjectSkillsDirectory()
    {
        ...
        {
            var candidate = Path.Combine(current, ".ardincode", "skills");
