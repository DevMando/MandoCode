    ...
    public static void Display()
    {
        ...
        AnsiConsole.Write(new Panel(
            new Rows(
                ...
                new Markup("  • ArdinCode sizes it automatically when you pick a model tier in /setup —"),
                new Markup("    but this only applies when ArdinCode starts the Ollama daemon itself."),
                ...
                new Markup("  • Tune ArdinCode's value with: [deepskyblue1]ardincode --config set contextLength 16384[/]"),
        ...
        AnsiConsole.Write(new Panel(
            new Rows(
                ...
                new Markup("[bold]Step 4:[/] Come back to ArdinCode — run [deepskyblue1]/setup[/] for a guided walkthrough or [deepskyblue1]/config[/] to pick the model directly")
            ))
        {
            Border = BoxBorder.Rounded,
