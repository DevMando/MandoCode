...
public static class SystemPrompts
{
    ...
    /// <summary>
    /// Builds the main system prompt for the ArdinCode AI assistant.
    ...
    /// it can't run.
    /// </summary>
    public static string BuildArdinCodeAssistant(bool webSearchEnabled)
    {
...
- ""I've created name.txt at: C:\Users\DevArdin\Desktop\ArdinCode\name.txt""
...
markdown link syntax like ""[path](file://...)"". ArdinCode's renderer automatically
