    ...
    public static void Display()
    {
        ...
        AnsiConsole.Write(new Panel(
            new Rows(
                ...
                new Markup("  • MandoCode sizes it automatically when you pick a local model in /setup or"),
                new Markup("    /model, and sends it with [bold]every request[/] — it wins over the Ollama desktop"),
                new Markup("    app's slider and the daemon's small ~4k default, no restart needed."),
                new Markup("  • Prefer Ollama to decide? Set contextLength to [deepskyblue1]0[/] and the daemon's own"),
                new Markup("    setting applies (desktop app: [deepskyblue1]Settings → Context length[/])."),
        ...
        AnsiConsole.Write(new Panel(
            new Rows(
                ...
                new Markup("                 Examples: glm-5.2:cloud, minimax-m3:cloud, kimi-k2.7-code:cloud"),
                new Markup(""),
        ...
        table.AddRow("[green]Cloud[/]", "glm-5.2:cloud", "No GPU required — default");
        table.AddRow("[green]Cloud[/]", "minimax-m3:cloud", "No GPU required");
        table.AddRow("[green]Cloud[/]", "kimi-k2.7-code:cloud", "No GPU required, code-focused");
