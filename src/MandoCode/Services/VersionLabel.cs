...
{
    /// <summary>Version label for the running assembly, e.g. "v0.15.0" or "v0.16.0-rc.1".</summary>
    ...
    /// e.g. <c>0.16.0-rc.1+a1a0df8</c>. Build metadata after '+' (appended by SourceLink) is
