...
public class McpConfigTests
{
    ...
    public void DeserializesClaudeDesktopStdioShape()
    {
        ...
        var config = JsonSerializer.Deserialize<ArdinCodeConfig>(json, new JsonSerializerOptions
        {
    ...
    {
        // Claude Desktop may add fields ArdinCode doesn't know about — deserialization
